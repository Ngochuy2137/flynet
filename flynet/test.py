...
def load_multiple_files(categories, num_files=20, num_samples_per_file=32, time_steps=30):
    ...
    for category in categories:
        ...
        file_paths = [f'/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/nae_static/proposal/objects/{category}/{category}_{i}.csv' for i in file_indices]
...
model_path = "/home/server-huynn/workspace/robot_catching_project/trajectory_prediction/nae_static/proposal/models/20250202_171238/best_model.pth"
